        ...
        {activeTab === 'overview' && (
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
              <div className="card p-6 bg-gradient-to-br from-blue-600 to-blue-700">
              ...
              <div className="card p-6 bg-gradient-to-br from-emerald-600 to-emerald-700">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-emerald-100 text-sm font-medium">College Admins</p>
              ...
              <div className="card p-6 bg-gradient-to-br from-purple-600 to-purple-700">
                <div className="flex items-center justify-between">
                  <div>
                  ...
                  <Calendar className="w-16 h-16 text-purple-200 opacity-50" />
                </div>
              </div>

              <div className="card p-6 bg-gradient-to-br from-orange-600 to-orange-700">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-orange-100 text-sm font-medium">Organizers</p>
                    <p className="text-4xl font-bold text-white mt-2">{organizers.length}</p>
                  </div>
                  <Shield className="w-16 h-16 text-orange-200 opacity-50" />
                </div>
              </div>
            </div>
          ...
          <div className="card p-6">
            ...
            {admins.length === 0 ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {admins.map(admin => (
                  <div key={admin.id} className="p-6 bg-purple-500/10 border border-purple-500/30 rounded-lg">
