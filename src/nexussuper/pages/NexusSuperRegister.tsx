...
import { Crown, Zap, Mail, Lock, User, Phone, Building, Key, ArrowRight, Eye, EyeOff, Shield } from 'lucide-react';
import PortalLink from '../../components/PortalLink';

const NexusSuperRegister: React.FC = () => {
  ...
  const { registerMaster, isLoading } = useAuth();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.name || !formData.email || !formData.password || !formData.phone || !formData.organization || !formData.masterCode) {
      setError('Please fill in all fields');
      return;
    }

    const result = await registerMaster(formData);
    if (result.success) {
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            <p style={{ color: '#fca5a5', fontSize: '0.8rem', margin: 0, lineHeight: '1.4' }}>
              Master Admin registration requires special authorization. All requests are reviewed and verified for security.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
            ...
            <div>
              <label style={labelStyle}>Master Authorization Code</label>
              <div style={{ position: 'relative' }}>
                <input
              ...
              <p style={{
                ...
                Contact system administrator for the master authorization code
              </p>
            </div>
        ...
        <div style={{ textAlign: 'center', marginTop: '2rem' }}>
          <p style={{
            ...
            © 2025 Nexus Master Portal • Ultimate System Control
          </p>
        </div>
      </div>
    </div>
...
export default NexusSuperRegister;