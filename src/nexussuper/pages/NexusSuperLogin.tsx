...
import { Crown, Zap, Mail, Lock, ArrowRight, Eye, EyeOff } from 'lucide-react';
import PortalLink from '../../components/PortalLink';

const NexusSuperLogin: React.FC = () => {
            ...
            <div>
              ...
              <div style={{ position: 'relative' }}>
                <input
                  ...
                  placeholder="Enter your master admin email"
                  required
                  onFocus={(e) => {
...
export default NexusSuperLogin;